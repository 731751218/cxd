...
/***/ 12:
/*!********************************************!*\
  !*** D:/宾果智造项目管理/车检服务/common/_function.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function request(url) {var _this = this;var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "GET";
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      ...
      success: function () {var _success = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(res) {var _ref, _ref2, error, _data, login;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!(

                  res.data.code == 300)) {_context.next = 11;break;}_context.next = 3;return (

                    uni.login({
                      provider: 'weixin' }));case 3:_ref = _context.sent;_ref2 = _slicedToArray(_ref, 2);error = _ref2[0];_data = _ref2[1];_context.next = 9;return (


                    _this.ajax(_this.api.login, {
                      code: _data.code },
                    'POST'));case 9:login = _context.sent;
                  if (login.data.code == 200) {
                    uni.setStorageSync('token', login.data.data);
                  }case 11:

                  resolve(res);case 12:case "end":return _context.stop();}}}, _callee, this);}));function success(_x) {return _success.apply(this, arguments);}return success;}(),
...
var BaseApi = 'https://cxd.vhost.binguo.me/'; //公司服务器环境
...
/***/ 14:
/*!*****************************************!*\
  !*** D:/宾果智造项目管理/车检服务/static/main.scss ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 21:
/*!******************************************!*\
  !*** D:/宾果智造项目管理/车检服务/common/amap-wx.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 262:
/*!************************************************************!*\
  !*** D:/宾果智造项目管理/车检服务/components/uni-calendar/calendar.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
